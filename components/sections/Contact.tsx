...
export default function Contact() {
  ...
  const handleWhatsApp = () => {
    ...
    // Do NOT use + sign or spaces
    const phoneNumber = "8801621961907";

    const message = encodeURIComponent(
      "Hello Mahfuz, I got your contact from your portfolio. I would like to get in touch with you!",
    );
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full lg:w-1/2 flex items-center justify-center gap-2 py-4 rounded-xl bg-accent hover:bg-accent/90 text-white font-semibold shadow-glow-purple transition-all duration-200 btn-shine disabled:opacity-50 disabled:cursor-not-allowed text-lg"
                    >
                      {sending ? (
                        <>
                    ...
                    <motion.button
                      ...
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="w-full lg:w-1/2 flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 py-4 px-8 rounded-xl text-white font-bold shadow-md transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                      {loading ? (
                        <>
                          <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />
